...
flowchart LR
    ...
    PRO["Prometeo — PLANNER<br/>deepseek-flash, max reasoning"]
    PYT["Pythia — SPEC"]
...
| Prometeo | The Forethinker (who plans before acting) | **Planner** — the only premium-reasoning role | `deepseek-flash`, `thinking` + `reasoning_effort=max` |
